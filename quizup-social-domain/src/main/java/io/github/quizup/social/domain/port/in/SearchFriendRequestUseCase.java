...
public interface SearchFriendRequestUseCase {

    CompletableFuture<PageResult<FriendRequest>> search(FriendRequestQuery.SearchFriendRequestQuery query);

    default CompletableFuture<PageResult<FriendRequest>> search(List<FilterCriteria> filters,
                                                                List<SortCriteria> sorts,
                                                                PageCriteria page) {
        return search(
                new FriendRequestQuery.SearchFriendRequestQuery(
                        filters,
                        sorts,
                        page
                )
