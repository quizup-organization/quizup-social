...
public final class ChallengeEntityMapper {
    ...
    public static Challenge toDomain(ChallengeEntity entity) {
        return new Challenge(
                ...
                entity.getTopicId(),
                entity.getGameId(),
                entity.getChallengerGameId(),
                entity.getChallengedGameId(),
                entity.getReplayGameId(),
                entity.getStatus(),
                entity.getCreatedAt(),
    ...
    public static ChallengeEntity toEntity(Challenge challenge) {
        ...
        entity.setChallengerGameId(challenge.challengerGameId());
        entity.setChallengedGameId(challenge.challengedGameId());
        entity.setReplayGameId(challenge.replayGameId());
