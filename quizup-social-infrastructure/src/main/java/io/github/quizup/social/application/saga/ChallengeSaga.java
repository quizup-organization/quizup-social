...
public class ChallengeSaga {
    ...
    @Autowired
    private transient ProfileRepositoryPort playerRepositoryPort;
    ...
    @Getter
    @Setter
    private ChallengeProfile challengerProfile;
    ...
    @Getter
    @Setter
    private ChallengeProfile challengedProfile;
    ...
    public void on(ChallengeEvent.ChallengeCreatedEvent event) {
        ...
        this.challengerProfile = playerRepositoryPort.getById(challengerId);
        this.challengedProfile = playerRepositoryPort.getById(challengedId);
